 ...
 *
 * The run order is the operator's own, given verbatim:
 *
 *   1 (3:00)   -1 (3:00)   -2 (2:00)   3 (2:00)   2 (2:00)   -3 (2:00)
 *   free debate (5:00 a side)   4 (3:00)   -4 (3:00)
 *
 * so the openers and the closers get 3:00, everyone in between gets 2:00, and Con closes
 * the round. 35:00 in total with the prep phase.
 *
...
export const chinese4v4: RoundConfig = {
  ...
  speakers: [
    ...
    { id: 'a2', side: 'A', name: '正二', role: { en: 'Cross-Examination', zh: '质询' }, defaultMs: 120_000 },
    { id: 'a3', side: 'A', name: '正三', role: { en: 'Rebuttal', zh: '驳论' }, defaultMs: 120_000 },
    { id: 'a4', side: 'A', name: '正四', role: { en: 'Closing Summary', zh: '总结陈词' }, defaultMs: 180_000 },
    { id: 'b1', side: 'B', name: '反一', role: { en: 'Opening Constructive', zh: '开篇立论' }, defaultMs: 180_000 },
    { id: 'b2', side: 'B', name: '反二', role: { en: 'Cross-Examination', zh: '质询' }, defaultMs: 120_000 },
    { id: 'b3', side: 'B', name: '反三', role: { en: 'Rebuttal', zh: '驳论' }, defaultMs: 120_000 },
    { id: 'b4', side: 'B', name: '反四', role: { en: 'Closing Summary', zh: '总结陈词' }, defaultMs: 180_000 },
  ],
  segments: [
    ...
    { id: 's4', kind: 'speech', speakerId: 'a3', allottedMs: null },
    {
      id: 's5',
      kind: 'speech',
      speakerId: 'a2',
    ...
    { id: 's7', kind: 'chess', label: FREE_DEBATE, perSideMs: 300_000, firstFloor: 'A' },
    { id: 's8', kind: 'speech', speakerId: 'a4', allottedMs: null },
    { id: 's9', kind: 'speech', speakerId: 'b4', allottedMs: null },
  ],
